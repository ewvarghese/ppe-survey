"""Verify the app works as a pure static site (what GitHub Pages serves)."""
import http.server, functools, threading, sys
from playwright.sync_api import sync_playwright

PORT = 5055
handler = functools.partial(http.server.SimpleHTTPRequestHandler, directory="/home/user/ppe-survey/static")
...
with sync_playwright() as p:
    ...
    pg.goto(f"http://127.0.0.1:{PORT}/submissions.html", wait_until="networkidle")
